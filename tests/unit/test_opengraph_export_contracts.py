...
try:
    ...
    # Only stub when the real package is genuinely unavailable -- unconditionally
...
from ocinferno.modules.opengraph.processing import process_oracle_cloud_hound_data as og  # noqa: E402
